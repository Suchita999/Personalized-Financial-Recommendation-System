"""
Feature Engineering for CE Interview Data
Creating demographic-based features for financial product prediction
"""
...
class CEFeatureEngineer:
    ...
    def create_financial_health_features(self, features_df):
        """Create financial health indicator features"""
        ...
        print("✓ Financial health features created")
        return features_df
    ...
    def create_interaction_features(self, features_df):
        ...
        # Income x Expenditure interactions
...
def main():
    ...
    engineer = CEFeatureEngineer(data_dir)
    ...
    engineer.save_features(output_dir / 'engineered_features.csv')
    ...
    print(features[['NEWID', 'age_ref', 'total_income', 'total_expenditure', 
                   'savings_rate', 'high_spender', 'financial_health_tier']].head())
